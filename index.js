...
//database
mongoose.connect('mongodb://localhost:27017/ofs',function(err)   //for link db to server
{
    if(err){
...
const custAddressModule = require("./model/customerAddress-model")
// get method calling
...
app.delete("/customeraddresses/:custAddressId",custAddressController.deletecustAddress)
app.put("/customeraddresses",custAddressController.updatecustAddress)
...
app.delete("/orderdetails/:order_detailId",orderDetailController.deleteOrder_details)
app.put("/orderdetails",orderDetailController.updateoeder_details)
...
app.put("/customization",customController.upadatecustomization)
